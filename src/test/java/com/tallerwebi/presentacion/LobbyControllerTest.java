...
public class LobbyControllerTest {
    ...
    public void deberiaCrearSalaYRedirigirASalaDeEspera() throws Exception {
        ...
        Mockito.when(partida2Service.crearPartida(Mockito.any(Partida2.class))).thenReturn(idPartida);
        ...
        Mockito.verify(partida2Service).crearPartida(Mockito.any(Partida2.class));
